# Simple Teeter Totter Game (Insider's model)
Not finished yet - bending model is pretty doubtful, left/right figure movement duplicates item dropping timeout. 
